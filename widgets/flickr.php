...
class hoffman_flickr_widget extends WP_Widget {
	...
	function __construct() {
        $widget_ops = array( 
			'classname' => 'hoffman_flickr_widget', 
			'description' => __('Displays your latest Flickr photos.', 'hoffman' ) 
		);
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'id' ) ); ?>"><?php _e( 'Flickr ID (use <a target="_blank" href="http://www.idgettr.com">idGettr</a>)', 'hoffman' ); ?>:
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php _e( 'Number of images to display', 'hoffman' ); ?>:
...
register_widget( 'hoffman_flickr_widget' ); ?>